...
<section id="pricing" class="py-24 bg-white border-b border-slate-100 relative" x-data="{ annual: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-center gap-3 mb-14">
            <span class="text-xs sm:text-sm font-semibold" :class="!annual ? 'text-[#0B152F]' : 'text-slate-400'">Monthly Billing</span>
            <button 
                type="button" 
                @click="annual = !annual"
            ...
            <span class="text-xs sm:text-sm font-semibold flex items-center gap-1.5" :class="annual ? 'text-[#0B152F]' : 'text-slate-400'">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            ...
            <div class="bg-white rounded-2xl p-8 border border-slate-200/80 hover:border-slate-300 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-lg">
                <div>
                    <h3 class="text-lg font-bold text-[#0B152F]">Basic</h3>
                    <p class="text-xs text-slate-400 mt-1">Perfect for small teams &amp; pilots</p>
                    ...
                    <ul class="mt-8 space-y-3.5 text-xs sm:text-sm text-slate-600 font-medium">
                ...
                <div class="mt-8 pt-6 border-t border-slate-100">
                    <a href="#lead-capture" class="w-full inline-flex items-center justify-center py-3 px-4 rounded-full text-xs font-bold border border-slate-200 text-slate-700 hover:border-teal-500 hover:text-teal-600 hover:bg-slate-50 transition active:scale-95">
                        Get Started &rarr;
                    </a>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-b from-teal-600 to-teal-700 rounded-2xl p-8 text-white flex flex-col justify-between shadow-2xl shadow-teal-900/20 relative lg:-translate-y-2 border-2 border-teal-400">
                <!-- Popular Badge -->
                <div class="absolute -top-3.5 right-6 bg-[#0B152F] text-teal-300 text-[10px] font-extrabold uppercase px-3.5 py-1 rounded-full border border-teal-500/60 tracking-wider shadow-md">
                    Most Popular
                </div>

                <div>
                    <h3 class="text-lg font-bold text-white">Growth</h3>
                    <p class="text-xs text-teal-100 mt-1">Ideal for scaling companies</p>
                    ...
                    <ul class="mt-8 space-y-3.5 text-xs sm:text-sm text-teal-50 font-medium">
                        <li class="flex items-center">
                ...
                <div class="mt-8 pt-6 border-t border-teal-500/50">
                    <a href="#lead-capture" class="w-full inline-flex items-center justify-center py-3 px-4 rounded-full text-xs font-bold bg-white text-teal-800 hover:bg-teal-50 transition shadow-lg active:scale-95">
                        Get Started &rarr;
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 border border-slate-200/80 hover:border-slate-300 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-lg">
                <div>
                    <h3 class="text-lg font-bold text-[#0B152F]">Enterprise</h3>
                    <p class="text-xs text-slate-400 mt-1">For multi-pod &amp; division scale</p>
            ...
            <div class="bg-gradient-to-b from-amber-50/60 to-amber-50/20 rounded-2xl p-8 border border-amber-200/90 hover:border-amber-300 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-lg">
                <div>
                    <h3 class="text-lg font-bold text-amber-950">Custom</h3>
                    <p class="text-xs text-amber-700/90 mt-1">Tailored to your exact blueprint</p>

                    <div class="mt-6 flex items-baseline">
                        <span class="text-2xl sm:text-3xl font-black text-[#0B152F]">Let's Talk</span>
                    </div>

                    <ul class="mt-8 space-y-3.5 text-xs sm:text-sm text-slate-700 font-medium">
                        <li class="flex items-center">
                ...
                <div class="mt-8 pt-6 border-t border-amber-200/70">
                    <a href="#lead-capture" class="w-full inline-flex items-center justify-center py-3 px-4 rounded-full text-xs font-bold bg-amber-400 hover:bg-amber-500 text-[#0B152F] transition shadow-md active:scale-95">
                        Contact Us &rarr;
                    </a>
                </div>
            </div>
