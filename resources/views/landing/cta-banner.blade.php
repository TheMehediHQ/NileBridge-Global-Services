...
<section class="py-24 sm:py-32 lg:py-36 bg-[#060D1D] relative overflow-hidden text-center border-t border-slate-800">
    ...
    <!-- Subtle Technical Network Arc Graphic -->
    <div class="absolute inset-0 flex items-center justify-center opacity-15 pointer-events-none -z-0">
        <svg class="w-full h-full max-w-6xl" viewBox="0 0 1000 400" fill="none">
            <path d="M 150 200 Q 300 100 500 220 T 850 180" stroke="#14b8a6" stroke-width="1.2" stroke-dasharray="4 4" />
            <path d="M 250 260 Q 500 120 750 240" stroke="#38bdf8" stroke-width="1" stroke-dasharray="3 3" />
            <circle cx="150" cy="200" r="3.5" fill="#14b8a6" />
            <circle cx="500" cy="220" r="4.5" fill="#2dd4bf" />
            <circle cx="850" cy="180" r="3.5" fill="#38bdf8" />
            <circle cx="300" cy="100" r="3" fill="#38bdf8" />
            <circle cx="750" cy="240" r="3" fill="#fbbf24" />
        </svg>
    </div>
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <!-- Subtitle -->
        <p class="mt-6 text-slate-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed font-normal">
            Find top global talent, streamline cross-border operations, and scale with confidence &mdash; from Kampala to the world.
        </p>
        ...
        <div class="mt-14 flex flex-wrap items-center justify-center gap-8 text-xs sm:text-sm text-slate-400 font-medium">
