...
<section id="process" class="py-24 bg-slate-50/60 border-b border-slate-100 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <!-- Horizontal Process Connector Line for Desktop -->
        <div class="hidden lg:block absolute top-[58%] left-12 right-12 h-0.5 bg-gradient-to-r from-teal-500/20 via-teal-500 to-teal-500/20 pointer-events-none -z-0"></div>

        <!-- 4 Step Process Cards Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            
            <!-- Step 01 -->
            <div class="bg-white rounded-2xl p-8 border border-slate-200/80 hover:border-teal-400 hover:shadow-xl transition-all duration-300 relative group flex flex-col justify-between">
                <div>
