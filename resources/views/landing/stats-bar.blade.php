...
<section class="border-y border-slate-200/70 bg-gradient-to-b from-slate-50/80 to-white py-10 relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 divide-y sm:divide-y-0 sm:divide-x divide-slate-200/80">
            <!-- Stat 1: 24/7 Support & Operations -->
            <div class="pt-4 sm:pt-0 sm:px-6 flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left group">
                <div class="w-12 h-12 rounded-2xl bg-teal-50 text-teal-600 flex items-center justify-center shrink-0 border border-teal-100 group-hover:bg-teal-500 group-hover:text-white transition duration-300 shadow-sm">
