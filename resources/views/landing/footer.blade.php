<!-- Section 12: Footer matching media_1789070132452.png -->
<footer class="bg-[#070D1E] text-slate-400 text-xs border-t border-slate-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800/80">
            ...
            <div>
                <div class="flex items-center gap-2.5 mb-4">
                    ...
                    <span class="text-base font-extrabold text-white tracking-tight">GlobalTalent</span>
                </div>
                <p class="text-slate-400 text-xs leading-relaxed mb-6">
                    Global Talent. Exceptional Operations.
                </p>

                <!-- Social Icons (LinkedIn, Twitter, YouTube, Instagram) -->
                <div class="flex items-center gap-3 text-slate-400">
                    <a href="#" class="w-8 h-8 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center hover:text-white hover:border-teal-500 transition">
            ...
            <div class="flex flex-col justify-between">
                <div class="w-full h-24 rounded-xl bg-slate-900/80 border border-slate-800 p-3 flex items-center justify-center relative overflow-hidden">
                ...
                <p class="text-[11px] text-slate-500 leading-snug mt-3">
        ...
        <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500 text-[11px]">
            <div>
                &copy; {{ date('Y') }} GlobalTalent. All rights reserved.
            </div>
