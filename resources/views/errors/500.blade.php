...
<div class="relative min-h-[80vh] bg-[#F8FAFC] text-slate-800 py-16 px-4 sm:px-6 lg:px-8 flex items-center justify-center overflow-hidden">
    ...
    <!-- Ambient Gradients -->
    <div class="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-rose-500/5 rounded-full blur-[140px] pointer-events-none -z-10"></div>
    ...
    <div class="max-w-lg w-full text-center space-y-6 relative z-10 bg-white border border-slate-200/90 p-8 sm:p-12 rounded-3xl shadow-[0_8px_30px_rgba(11,21,47,0.06)]">
        <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono font-bold uppercase tracking-wider bg-rose-50 text-rose-700 border border-rose-200">
            ...
            Error 500 &bull; Infrastructure Alert
        </div>
        ...
        <p class="text-sm text-slate-500 leading-relaxed max-w-sm mx-auto">
            Our systems encountered an unexpected internal error. Our Site Reliability Engineering team has received the alert and is investigating.
        </p>
        ...
        <div class="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="mailto:support@nilebridge.com" class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 rounded-full text-sm font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 transition">
                Contact Ops Support
            </a>
        </div>
    </div>
