            ...
            <div class="flex items-center justify-between h-20 py-3">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('home') }}" class="flex items-center space-x-3 group">
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-teal-500 to-cyan-400 flex items-center justify-center text-[#070D1E] font-black text-sm shadow-lg shadow-teal-500/20 group-hover:scale-105 transition shrink-0">
                            <svg class="w-5 h-5 text-[#070D1E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="flex flex-col justify-center">
                            <span class="text-xl sm:text-2xl font-black tracking-tight text-white group-hover:text-teal-400 transition leading-tight">NileBridge</span>
                            <span class="text-[11px] sm:text-xs tracking-widest uppercase font-bold text-teal-400 leading-none">Global Services</span>
                        </div>
                    </a>
                </div>
